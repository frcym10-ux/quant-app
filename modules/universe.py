...
THEMES: dict[str, dict[str, str]] = {
    ...
    "セクターETF（値がさ個別の代替）": {
        "2644": "GX半導体日本株ETF",   # 半導体(日本): アドバンテスト・東エレク・レーザーテック等の代替
        "2243": "GX半導体ETF",          # 半導体(米SOX円換算): 円高がマイナスに効く
        "513A": "GX防衛テック日本株ETF", # 防衛(日本): 三菱重工・川崎重工・IHI・NEC・アストロスケール等13銘柄
        "466A": "GX防衛テックETF",       # 防衛(グローバル): 円換算・為替ヘッジなし
        "1627": "NF電力ガスETF",         # 電力ガス: ディフェンシブ
        "1625": "NF電機精密ETF",         # 電機精密 ※単元約7万円と高く値がさ代替にならない場合あり
    },
}
